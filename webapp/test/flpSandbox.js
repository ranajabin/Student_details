		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#tableandform1tableandformproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tableandform1tableandformproject1-display": {
								"semanticObject": "tableandform1tableandformproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tableandform1.tableandformproject1",
									"url": sap.ui.require.toUrl("tableandform1/tableandformproject1")
								}
							}
						}
					}
